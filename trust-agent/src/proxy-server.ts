...
async function bootstrap() {
  ...
  console.log(
    "Proxy B pubkey (hex):",
    Buffer.from(proxyBKey.publicKey).toString("hex")
  );
  ...
  console.log(
    "\n[DEMO] Proxy A pubkey (hex):",
    Buffer.from(proxyAKey.publicKey).toString("hex")
  );
  console.log(
    "[DEMO] Proxy A privkey (hex):",
    Buffer.from(proxyAKey.privateKey).toString("hex")
  );
